...
// Note: All diagram code is from trusted static sources (learningData.js), not user input
mermaid.initialize({
  startOnLoad: false,
  theme: 'default',
...
function MermaidDiagram({ code }) {
  ...
  return (
    <div className="mermaid-container" ref={containerRef}>
      <div className="mermaid-label">📊 Diagram</div>
      {svg ? (
        // Safe: SVG is generated by mermaid from trusted static learningData.js content
        <div 
